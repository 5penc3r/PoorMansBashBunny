...
logging.basicConfig(filename='/var/log/bunny.log', level="INFO")
...
# IO port definitions
IO_LEDS = {"green":3, "red":2} # green on gpio 19. etc
IO_DIP = [5, 6, 13, 19] # Dip switch1 on io pin2, switch2 on io pin3 etc.
IO_BUTTONS = {"green":10, "red":17} # green button on io 13 etc
